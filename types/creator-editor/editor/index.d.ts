...
export declare class BaseEditor {
    get remote(): any;
    Dialog: {
        select(options?: import("./dialog/public/interface").SelectDialogOptions, window?: Electron.BrowserWindow): Promise<string[]>;
        save(options?: import("./dialog/public/interface").SelectDialogOptions, window?: Electron.BrowserWindow): Promise<string>;
        info(message: string, options?: import("./dialog/public/interface").MessageDialogOptions, window?: Electron.BrowserWindow): Promise<number>;
        warn(message: string, options?: import("./dialog/public/interface").MessageDialogOptions, window?: Electron.BrowserWindow): Promise<number>;
        error(message: string, options?: import("./dialog/public/interface").MessageDialogOptions, window?: Electron.BrowserWindow): Promise<number>;
    };
    EditMode: {
